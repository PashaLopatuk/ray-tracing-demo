...
import Material, { DIELECTRIC_MATERIAL, EMISSIVE_MATERIAL, REFLECTIVE_MATERIAL } from '../../lib/scene/Material';
import { bvMinDelta, Face, Model, Mtl, ParsedObj } from '@/models/objects';
import { BV } from '@/models/bv';


export class CornelBoxScene {
  objUrl: string;
  mtlUrl: string;
  objCount: number;
  mtlCount: number;
    ...
    if (this.GL) {
      ...
      this.parsedMtls = wavefrontMtl.map((mtl: Mtl) => {
        ...
        switch (mtl.name) {
          ...
          case 'DarkGreen':
            mat.mtlCls = REFLECTIVE_MATERIAL;
            mat.albedo.r = 0.0;
            mat.albedo.g = 0.32;
            mat.albedo.b = 0.0;
          ...
          case 'Khaki':
            ...
            mat.albedo.g = 0.659;
            mat.albedo.b = 0.439;
            mat.reflectionRatio = 0.4;
            mat.reflectionGloss = 0.6;
            break;
